<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Historial_Clientes.aspx.cs" Inherits="TP_Integrador_GF.Historial_Clientes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <div class="miDiv">
        ...
        <div>
            <asp:Label runat="server" CssClass="titulo" >Historial de Clientes</asp:Label>
            <hr />
        </div>
         ...
         <% if (GridClientes.Rows.Count == 0)
           ...
           <%}
              ...
              {%>
                    ...
                    <asp:GridView ID="GridClientes" runat="server" PageSize="2" AutoGenerateColumns="false" AllowPaging="true" Visible="true" CssClass="mi-gridview" OnPageIndexChanging="GridClientes_PageIndexChanging" OnRowDeleting="GridClientes_RowDeleting" OnSelectedIndexChanged="GridClientes_SelectedIndexChanged" DataKeyNames="id">
                        <Columns>
                            <asp:BoundField DataField="Nombre" HeaderText="Cliente" />
                            <asp:BoundField DataField="Apellido" HeaderText="Apellido" />
                            <asp:BoundField Datafield="DNI" HeaderText="DNI" />
                            <asp:BoundField Datafield="Email" HeaderText="Email" />
                            <asp:BoundField Datafield="Telefono" HeaderText="Telefono de contacto" />
